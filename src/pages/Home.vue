            ...
            <dl class="mt-5 grid grid-cols-1 rounded-lg bg-white overflow-hidden shadow divide-y divide-gray-200 md:grid-cols-3 md:divide-y-0 md:divide-x">
              <div class="px-4 py-5 sm:p-6">
                ...
                <dd class="mt-1 flex justify-between items-baseline md:block lg:flex">
                  ...
                  <div v-if="data.udgifter.this_month < data.udgifter.last_month" class="inline-flex items-baseline px-2.5 py-0.5 rounded-full text-sm font-medium bg-red-100 text-red-800 md:mt-2 lg:mt-0">
                    ...
                    {{ (data.udgifter.this_month-data.udgifter.last_month) }}
                  </div>

                  <div v-if="data.udgifter.this_month > data.udgifter.last_month" class="inline-flex items-baseline px-2.5 py-0.5 rounded-full text-sm font-medium bg-green-100 text-green-800 md:mt-2 lg:mt-0">
                  ...
                  <div v-if="data.udgifter.this_month = data.udgifter.last_month" class="inline-flex items-baseline px-2.5 py-0.5 rounded-full text-sm font-medium bg-blue-100 text-blue-800 md:mt-2 lg:mt-0">
                    0%
                  </div>
