<template>
  ...
  <div class="h-screen flex overflow-hidden bg-white">
        ...
        <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto">
          ...
          <nav aria-label="Sidebar" class="mt-5">
            <div class="px-2 space-y-1">
              ...
              <router-link to="/" class="bg-gray-100 text-gray-900 group flex items-center px-2 py-2 text-base font-medium rounded-md">
        ...
        <div class="flex flex-col h-0 flex-1 border-r border-gray-200 bg-white">
          <div class="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
            <div class="flex items-center flex-shrink-0 px-4">
              <img class="h-8 w-auto" src="https://tailwindui.com/img/logos/workflow-logo-indigo-600-mark-gray-900-text.svg" alt="Min Passwordmanager">
            </div>
            <nav class="mt-5 flex-1" aria-label="Sidebar">
              <div class="px-2 space-y-1">
                <!-- Current: "bg-gray-200 text-gray-900", Default: "text-gray-600 hover:bg-gray-50 hover:text-gray-900" -->
                <router-link to="/" class="sidebar-menu-item" active-class="sidebar-menu-item-active">
                  <!-- Current: "text-gray-500", Default: "text-gray-400 group-hover:text-gray-500" -->
                  <!-- Heroicon name: outline/home -->
                  <svg class="sidebar-menu-svg" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                  </svg>
                  Dashboard
                </router-link> 
    ...
    <div class="flex flex-col min-w-0 flex-1 overflow-hidden lg:hidden">
      <div class="lg:hidden">
  ...
  <div class="flex-1 relative z-0 flex overflow-hidden" id="test">
    <router-view/>
  </div>
...
export default {
  ...
  //     this.$store.commit('appMetaData/initialiseAppInfo', this.thememode)
  //   },
  //   unsetTheme() {
  //     this.$store.commit('appMetaData/uninitialiseAppInfo')
  //   }
  // },
  
  // beforeCreate() { 
  //   console.log(this.$store.state.appMetaData)
  // },
}
</script>